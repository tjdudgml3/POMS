...
from poms.reader import SpectralLibraryReader
from poms.spectrum import SpectrumSpectrumMatch
...
def write_mztab(identifications: List[SpectrumSpectrumMatch], filename: str,
    ...
    metadata = [
        ...
        ('mzTab-ID', f'POMS_{filename}'),
        ('title', f'POMS identification file "{filename}"'),
        ...
        ('software[1]', f'[MS, MS:1001456, POMS, {__version__}]'),
